---
name: ai-integration
description: Anthropic SDK integration for both runtimes — model id, TypeScript/Python client setup, streaming, structured output via tool use, prompt file management, input sanitization, and AI security rules. Use when adding LLM calls, prompts, or AI pipelines.
---
