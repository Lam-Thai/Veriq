---
name: sqlalchemy
description: SQLAlchemy async usage for the FastAPI runtime (mirrors the Prisma schema, never migrates) — async session setup, model conventions matching Prisma PascalCase, query patterns (select/soft-delete/transaction/pagination), and Pydantic serialization. Use when writing FastAPI DB code.
---
