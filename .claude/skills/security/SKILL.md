---
name: security
description: Shared security toolbelt for both runtimes — input validation, auth cookies, service tokens, rate limiting, security headers, CORS, startup env validation, and file-upload safety. Use when hardening auth/API/data code or doing a security pass.
---
