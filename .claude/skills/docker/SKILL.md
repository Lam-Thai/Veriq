---
name: docker
description: Containerization conventions for both runtimes — multi-stage builds, non-root users, healthchecks, and the secret-vs-public-build-arg distinction. Use when writing or reviewing a Dockerfile, docker-compose.yml, or .dockerignore.
---
