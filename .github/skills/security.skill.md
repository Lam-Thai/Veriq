...
```
See `#file:.github/skills/ai-integration.skill.md`'s "Input Sanitization" section for the full
real example (`lib/ai-sanitize.ts`).
...
partitioned by user. See `#file:.github/skills/ai-integration.skill.md`'s "Free-tier realities"
section for the concrete example this pattern came from.
