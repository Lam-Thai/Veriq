...
| Skill | Purpose |
|---|---|
| `#file:.github/skills/typescript.skill.md` | Types, metadata typing, discriminated unions |
| `#file:.github/skills/nextjs.skill.md` | `proxy.ts` (not `middleware.ts`), App Router, Server Actions |
| `#file:.github/skills/prisma.skill.md` | Ownership-scoped queries — key every table on Clerk's `userId` |
| `#file:.github/skills/api-contracts.skill.md` | 404-not-403 envelope for ownership failures |
| `#file:.github/skills/security.skill.md` | Third-party-SDK production checks, CI secret hygiene, rate limiting |
