...
3. If touching the Checkout route: verify the duplicate-subscription guard, the create-race
   ...
   still present after your change (see `#file:.github/skills/payments.skill.md`).
...
From this repo's first Stripe integration and its security audits — see `#file:.github/skills/payments.skill.md` for
